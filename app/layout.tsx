...
export const metadata: Metadata = {
  ...
  verification: {
    google: "LF0EkL5hrd-mZ58GiiubfUJcruHZT2WuaCahORivC_Q",
  },
  ...
  openGraph: { type: "website", siteName: "LawnsGuide", locale: "en_US" },
